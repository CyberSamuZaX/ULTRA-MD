...
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '94765718443r';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'DARK-SAMUZA';
global.pairingNumber = process.env.BOT_NUMBER || '94765718443';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'GMZEwAwR#Ysv0pT4qYCEMal8Y-cSakMZ3yKmO0B_D4bMQM0nOBHI';  // put your session id here
